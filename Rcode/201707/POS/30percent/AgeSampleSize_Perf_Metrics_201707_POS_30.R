...
savefile <- "Rcode/201707/POS/30percent/Output/final_output_201707_pos_30.xlsx" # change to where you want to save output file
saverds <- "Rcode/201707/POS/30percent/Output/final_output_201707_pos_30.rds" # change to where you want to save output file
saverds.af <- "Rcode/201707/POS/30percent/Output/af_metrics_long_pos_30.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/201707/POS/30percent/Output/mla_ind_model_metrics_long_pos_30.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/201707/POS/30percent/Output/mla_ind_pop_metrics_long_pos_30.rds" # change to where you want to save output file
saverds.alk <- "Rcode/201707/POS/30percent/Output/alk_data_all_pos_30.rds"
saverds.alk.matrix.model <- "Rcode/201707/POS/30percent/Output/alk.matrix_model_pos_30.rds"
saverds.subset.data <- "Rcode/201707/POS/30percent/Output/subset_data_30.rds" # change to where you want to save output file
