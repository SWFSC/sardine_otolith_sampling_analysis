...
savefile <- "Rcode/201707/Hybrid/Run-4050/Output/final_output_201707_hy_r4050.xlsx" # change to where you want to save output file
saverds <- "Rcode/201707/Hybrid/Run-4050/Output/final_output_201707_hy_r4050.rds" # change to where you want to save output file
saverds.af <- "Rcode/201707/Hybrid/Run-4050/Output/af_metrics_long_hy_r4050.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/201707/Hybrid/Run-4050/Output/mla_ind_model_metrics_long_hy_r4050.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/201707/Hybrid/Run-4050/Output/mla_ind_pop_metrics_long_hy_r4050.rds" # change to where you want to save output file
saverds.alk <- "Rcode/201707/Hybrid/Run-4050/Output/alk_data_all_r4050.rds"
saverds.alk.matrix.model <- "Rcode/201707/Hybrid/Run-4050/Output/alk.matrix_model_hy_r4050.rds"
saverds.subset.data <- "Rcode/201707/Hybrid/Run-4050/Output/subset_data_r4050.rds"
