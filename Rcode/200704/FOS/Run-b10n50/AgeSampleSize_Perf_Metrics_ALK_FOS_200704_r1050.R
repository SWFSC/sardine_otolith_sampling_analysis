...
savefile <- "Rcode/200704/FOS/Run-b10n50/Output/final_output_200704_fos_1050.xlsx" # change to where you want to save output file
saverds <- "Rcode/200704/FOS/Run-b10n50/Output/final_output_200704_fos_1050.rds" # change to where you want to save output file
saverds.af <- "Rcode/200704/FOS/Run-b10n50/Output/af_metrics_long_fos_1050.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/200704/FOS/Run-b10n50/Output/mla_ind_model_metrics_long_fos_r1050.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/200704/FOS/Run-b10n50/Output/mla_ind_pop_metrics_long_fos_r1050.rds" # change to where you want to save output file
saverds.alk <- "Rcode/200704/FOS/Run-b10n50/Output/alk_data_all_r1050.rds"
saverds.alk.matrix.model <- "Rcode/200704/FOS/Run-b10n50/Output/alk.matrix_model_fos_r1050.rds"
saverds.subset.data <- "Rcode/200704/FOS/Run-b10n50/Output/subset_data_r1050.rds" # change to where you want to save output file
