...
savefile <- "Rcode/200704/POS/50percent/Output/final_output_200704_pos_50.xlsx" # change to where you want to save output file
saverds <- "Rcode/200704/POS/50percent/Output/final_output_200704_pos_50.rds" # change to where you want to save output file
saverds.af <- "Rcode/200704/POS/50percent/Output/af_metrics_long_pos_50.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/200704/POS/50percent/Output/mla_ind_model_metrics_long_pos_50.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/200704/POS/50percent/Output/mla_ind_pop_metrics_long_pos_50.rds" # change to where you want to save output file
saverds.alk <- "Rcode/200704/POS/50percent/Output/alk_data_all_pos_50.rds"
saverds.alk.matrix.model <- "Rcode/200704/POS/50percent/Output/alk.matrix_model_pos_50.rds"
saverds.subset.data <- "Rcode/200704/POS/50percent/Output/subset_data_50.rds" # change to where you want to save output file
