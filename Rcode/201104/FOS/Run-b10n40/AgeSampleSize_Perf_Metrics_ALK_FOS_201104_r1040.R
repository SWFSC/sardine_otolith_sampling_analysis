...
savefile <- "Rcode/201104/FOS/Run-b10n40/Output/final_output_201104_fos_1040.xlsx" # change to where you want to save output file
saverds <- "Rcode/201104/FOS/Run-b10n40/Output/final_output_201104_fos_1040.rds" # change to where you want to save output file
saverds.af <- "Rcode/201104/FOS/Run-b10n40/Output/af_metrics_long_fos_1040.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/201104/FOS/Run-b10n40/Output/mla_ind_model_metrics_long_fos_r1040.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/201104/FOS/Run-b10n40/Output/mla_ind_pop_metrics_long_fos_r1040.rds" # change to where you want to save output file
saverds.alk <- "Rcode/201104/FOS/Run-b10n40/Output/alk_data_all_r1040.rds"
saverds.alk.matrix.model <- "Rcode/201104/FOS/Run-b10n40/Output/alk.matrix_model_fos_r1040.rds"
saverds.subset.data <- "Rcode/201104/FOS/Run-b10n40/Output/subset_data_r1040.rds" # change to where you want to save output file
