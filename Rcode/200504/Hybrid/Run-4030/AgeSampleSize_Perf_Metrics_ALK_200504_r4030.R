...
savefile <- "Rcode/200504/Hybrid/Run-4030/Output/final_output_200504_hy_r4030.xlsx" # change to where you want to save output file
saverds <- "Rcode/200504/Hybrid/Run-4030/Output/final_output_200504_hy_r4030.rds" # change to where you want to save output file
saverds.af <- "Rcode/200504/Hybrid/Run-4030/Output/af_metrics_long_hy_r4030.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/200504/Hybrid/Run-4030/Output/mla_ind_model_metrics_long_hy_r4030.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/200504/Hybrid/Run-4030/Output/mla_ind_pop_metrics_long_hy_r4030.rds" # change to where you want to save output file
saverds.alk <- "Rcode/200504/Hybrid/Run-4030/Output/alk_data_all_r4030.rds"
saverds.alk.matrix.model <- "Rcode/200504/Hybrid/Run-4030/Output/alk.matrix_model_hy_r4030.rds"
saverds.subset.data <- "Rcode/200504/Hybrid/Run-4030/Output/subset_data_r4030.rds"
