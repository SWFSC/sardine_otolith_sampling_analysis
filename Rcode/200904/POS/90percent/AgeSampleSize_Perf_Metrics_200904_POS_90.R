...
savefile <- "Rcode/200904/POS/90percent/Output/final_output_200904_pos_90.xlsx" # change to where you want to save output file
saverds <- "Rcode/200904/POS/90percent/Output/final_output_200904_pos_90.rds" # change to where you want to save output file
saverds.af <- "Rcode/200904/POS/90percent/Output/af_metrics_long_pos_90.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/200904/POS/90percent/Output/mla_ind_model_metrics_long_pos_90.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/200904/POS/90percent/Output/mla_ind_pop_metrics_long_pos_90.rds" # change to where you want to save output file
saverds.alk <- "Rcode/200904/POS/90percent/Output/alk_data_all_pos_90.rds"
saverds.alk.matrix.model <- "Rcode/200904/POS/90percent/Output/alk.matrix_model_pos_90.rds"
saverds.subset.data <- "Rcode/200904/POS/90percent/Output/subset_data_90.rds" # change to where you want to save output file
