...
savefile <- "Rcode/200904/Hybrid/Run-3010/Output/final_output_200904_hy_r3010.xlsx" # change to where you want to save output file
saverds <- "Rcode/200904/Hybrid/Run-3010/Output/final_output_200904_hy_r3010.rds" # change to where you want to save output file
saverds.af <- "Rcode/200904/Hybrid/Run-3010/Output/af_metrics_long_hy_r3010.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/200904/Hybrid/Run-3010/Output/mla_ind_model_metrics_long_hy_r3010.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/200904/Hybrid/Run-3010/Output/mla_ind_pop_metrics_long_hy_r3010.rds" # change to where you want to save output file
saverds.alk <- "Rcode/200904/Hybrid/Run-3010/Output/alk_data_all_r3010.rds"
saverds.alk.matrix.model <- "Rcode/200904/Hybrid/Run-3010/Output/alk.matrix_model_hy_r3010.rds"
saverds.subset.data <- "Rcode/200904/Hybrid/Run-3010/Output/subset_data_r3010.rds"
