...
#  THIS replicated the allyears analysis but just for the certain year
#######################################################################
# 201207
# change the bins for runs here
source("Functions/AgeSampleSize_Functions_ALK_noAge0_years.R")
run <- "10-10" # change based on run
savefile <- "Rcode/201207/FOS/Run-b10n10/Output/final_output_201207_fos_1010.xlsx" # change to where you want to save output file
saverds <- "Rcode/201207/FOS/Run-b10n10/Output/final_output_201207_fos_1010.rds" # change to where you want to save output file
saverds.af <- "Rcode/201207/FOS/Run-b10n10/Output/af_metrics_long_fos_1010.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/201207/FOS/Run-b10n10/Output/mla_ind_model_metrics_long_fos_r1010.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/201207/FOS/Run-b10n10/Output/mla_ind_pop_metrics_long_fos_r1010.rds" # change to where you want to save output file
saverds.alk <- "Rcode/201207/FOS/Run-b10n10/Output/alk_data_all_r1010.rds"
saverds.alk.matrix.model <- "Rcode/201207/FOS/Run-b10n10/Output/alk.matrix_model_fos_r1010.rds"
saverds.subset.data <- "Rcode/201207/FOS/Run-b10n10/Output/subset_data_r1010.rds" # change to where you want to save output file
