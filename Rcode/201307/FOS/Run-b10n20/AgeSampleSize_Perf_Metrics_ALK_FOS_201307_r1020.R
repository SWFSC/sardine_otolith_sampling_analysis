...
savefile <- "Rcode/201307/FOS/Run-b10n20/Output/final_output_201307_fos_1020.xlsx" # change to where you want to save output file
saverds <- "Rcode/201307/FOS/Run-b10n20/Output/final_output_201307_fos_1020.rds" # change to where you want to save output file
saverds.af <- "Rcode/201307/FOS/Run-b10n20/Output/af_metrics_long_fos_1020.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/201307/FOS/Run-b10n20/Output/mla_ind_model_metrics_long_fos_r1020.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/201307/FOS/Run-b10n20/Output/mla_ind_pop_metrics_long_fos_r1020.rds" # change to where you want to save output file
saverds.alk <- "Rcode/201307/FOS/Run-b10n20/Output/alk_data_all_r1020.rds"
saverds.alk.matrix.model <- "Rcode/201307/FOS/Run-b10n20/Output/alk.matrix_model_fos_r1020.rds"
saverds.subset.data <- "Rcode/201307/FOS/Run-b10n20/Output/subset_data_r1020.rds" # change to where you want to save output file
