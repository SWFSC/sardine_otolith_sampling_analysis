...
savefile <- "Rcode/201907/POS/70percent/Output/final_output_201907_pos_70.xlsx" # change to where you want to save output file
saverds <- "Rcode/201907/POS/70percent/Output/final_output_201907_pos_70.rds" # change to where you want to save output file
saverds.af <- "Rcode/201907/POS/70percent/Output/af_metrics_long_pos_70.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/201907/POS/70percent/Output/mla_ind_model_metrics_long_pos_70.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/201907/POS/70percent/Output/mla_ind_pop_metrics_long_pos_70.rds" # change to where you want to save output file
saverds.alk <- "Rcode/201907/POS/70percent/Output/alk_data_all_pos_70.rds"
saverds.alk.matrix.model <- "Rcode/201907/POS/70percent/Output/alk.matrix_model_pos_70.rds"
saverds.subset.data <- "Rcode/201907/POS/70percent/Output/subset_data_70.rds" # change to where you want to save output file
