#######################################################################
#
#  SIMULATE AGE LENGTH KEY (ALK) FOR A 
#  
#
#######################################################################
# 200404 ##
...
savefile <- "Rcode/200404/POS/30percent/Output/final_output_200404_pos_30.xlsx" # change to where you want to save output file
saverds <- "Rcode/200404/POS/30percent/Output/final_output_200404_pos_30.rds" # change to where you want to save output file
saverds.af <- "Rcode/200404/POS/30percent/Output/af_metrics_long_pos_30.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/200404/POS/30percent/Output/mla_ind_model_metrics_long_pos_30.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/200404/POS/30percent/Output/mla_ind_pop_metrics_long_pos_30.rds" # change to where you want to save output file
saverds.alk <- "Rcode/200404/POS/30percent/Output/alk_data_all_pos_30.rds"
saverds.alk.matrix.model <- "Rcode/200404/POS/30percent/Output/alk.matrix_model_pos_30.rds"
saverds.subset.data <- "Rcode/200404/POS/30percent/Output/subset_data_30.rds" # change to where you want to save output file
