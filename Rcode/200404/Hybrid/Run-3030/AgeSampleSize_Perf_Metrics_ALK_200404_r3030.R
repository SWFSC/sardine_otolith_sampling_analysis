...
savefile <- "Rcode/200404/Hybrid/Run-3030/Output/final_output_200404_hy_r3030.xlsx" # change to where you want to save output file
saverds <- "Rcode/200404/Hybrid/Run-3030/Output/final_output_200404_hy_r3030.rds" # change to where you want to save output file
saverds.af <- "Rcode/200404/Hybrid/Run-3030/Output/af_metrics_long_hy_r3030.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/200404/Hybrid/Run-3030/Output/mla_ind_model_metrics_long_hy_r3030.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/200404/Hybrid/Run-3030/Output/mla_ind_pop_metrics_long_hy_r3030.rds" # change to where you want to save output file
saverds.alk <- "Rcode/200404/Hybrid/Run-3030/Output/alk_data_all_r3030.rds"
saverds.alk.matrix.model <- "Rcode/200404/Hybrid/Run-3030/Output/alk.matrix_model_hy_r3030.rds"
saverds.subset.data <- "Rcode/200404/Hybrid/Run-3030/Output/subset_data_r3030.rds"
