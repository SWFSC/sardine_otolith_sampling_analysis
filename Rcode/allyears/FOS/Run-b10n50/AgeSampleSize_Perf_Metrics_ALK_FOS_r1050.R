...
run <- "10-50" # change based on run
savefile <- "Rcode/allyears/FOS/Run-b10n50/Output/final_output_allyears_fos_r1050.xlsx" # change to where you want to save output file
saverds <- "Rcode/allyears/FOS/Run-b10n50/Output/final_output_allyears_fos_r1050.rds" # change to where you want to save output file
saverds.af <- "Rcode/allyears/FOS/Run-b10n50/Output/af_metrics_long_fos_r1050.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/allyears/FOS/Run-b10n50/Output/mla_ind_model_metrics_long_fos_r1050.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/allyears/FOS/Run-b10n50/Output/mla_ind_pop_metrics_long_fos_r1050.rds" # change to where you want to save output file
saverds.alk <- "Rcode/allyears/FOS/Run-b10n50/Output/alk_data_all_r1050.rds"
saverds.alk.matrix.model <- "Rcode/allyears/FOS/Run-b10n50/Output/alk.matrix_model_fos_r1050.rds"
saverds.subset.data <- "Rcode/allyears/FOS/Run-b10n50/Output/subset_data_r1050.rds" # change to where you want to save output file
