...
run <- "10-250" # change based on run
savefile <- "Rcode/allyears/FOS/Run-b10n250/Output/final_output_allyears_fos_r10250.xlsx" # change to where you want to save output file
saverds <- "Rcode/allyears/FOS/Run-b10n250/Output/final_output_allyears_fos_r10250.rds" # change to where you want to save output file
saverds.af <- "Rcode/allyears/FOS/Run-b10n250/Output/af_metrics_long_fos_r10250.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/allyears/FOS/Run-b10n250/Output/mla_ind_model_metrics_long_fos_r10250.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/allyears/FOS/Run-b10n250/Output/mla_ind_pop_metrics_long_fos_r10250.rds" # change to where you want to save output file
saverds.alk <- "Rcode/allyears/FOS/Run-b10n250/Output/alk_data_all_r10250.rds"
saverds.alk.matrix.model <- "Rcode/allyears/FOS/Run-b10n250/Output/alk.matrix_model_fos_r10250.rds"
saverds.subset.data <- "Rcode/allyears/FOS/Run-b10n250/Output/subset_data_r10250.rds" # change to where you want to save output file
