...
run <- "30-10" # change based on run
savefile <- "Rcode/allyears/Hybrid/Run-3010/Output/final_output_allyears_hy_r3010.xlsx" # change to where you want to save output file
saverds <- "Rcode/allyears/Hybrid/Run-3010/Output/final_output_allyears_hy_r3010.rds" # change to where you want to save output file
saverds.ma <- "Rcode/allyears/Hybrid/Run-3010/Output/ma_metrics_long_hy_r3010.rds" # change to where you want to save output file
saverds.af <- "Rcode/allyears/Hybrid/Run-3010/Output/af_metrics_long_hy_r3010.rds" # change to where you want to save output file
saverds.mla <- "Rcode/allyears/Hybrid/Run-3010/Output/mla_metrics_long_hy_r3010.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/allyears/Hybrid/Run-3010/Output/mla_ind_model_metrics_long_hy_r3010.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/allyears/Hybrid/Run-3010/Output/mla_ind_pop_metrics_long_hy_r3010.rds" # change to where you want to save output file
saverds.alk <- "Rcode/allyears/Hybrid/Run-3010/Output/alk_data_all_r3010.rds"
saverds.alk.matrix.model <- "Rcode/allyears/Hybrid/Run-3010/Output/alk.matrix_model_hy_r3010.rds"
saverds.subset.data <- "Rcode/allyears/Hybrid/Run-3010/Output/subset_data_hy_r3010.rds" # change to where you want to save output file
