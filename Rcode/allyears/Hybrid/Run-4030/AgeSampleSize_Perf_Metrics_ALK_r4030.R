...
source("Functions/AgeSampleSize_Functions_ALK.R")
run <- "40-30" # change based on run
savefile <- "Rcode/allyears/Hybrid/Run-4030/Output/final_output_allyears_hy_r4030.xlsx" # change to where you want to save output file
saverds <- "Rcode/allyears/Hybrid/Run-4030/Output/final_output_allyears_hy_r4030.rds" # change to where you want to save output file
saverds.ma <- "Rcode/allyears/Hybrid/Run-4030/Output/ma_metrics_long_hy_r4030.rds" # change to where you want to save output file
saverds.af <- "Rcode/allyears/Hybrid/Run-4030/Output/af_metrics_long_hy_r4030.rds" # change to where you want to save output file
saverds.mla <- "Rcode/allyears/Hybrid/Run-4030/Output/mla_metrics_long_hy_r4030.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/allyears/Hybrid/Run-4030/Output/mla_ind_model_metrics_long_hy_r4030.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/allyears/Hybrid/Run-4030/Output/mla_ind_pop_metrics_long_hy_r4030.rds" # change to where you want to save output file
saverds.alk <- "Rcode/allyears/Hybrid/Run-4030/Output/alk_data_all_r4030.rds"
saverds.alk.matrix.model <- "Rcode/allyears/Hybrid/Run-4030/Output/alk.matrix_model_hy_r4030.rds"
saverds.subset.data <- "Rcode/allyears/Hybrid/Run-4030/Output/subset_data_hy_r4030.rds" # change to where you want to save output file
...
pop <- sardine #bring data in here, then call it in other file

samp_size <- percent*nrow(pop)
