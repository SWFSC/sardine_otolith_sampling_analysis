...
run <- "50%" # change based on run
savefile <- "Rcode/allyears/POS/50percent/Output/final_output_allyears_pos_50.xlsx" # change to where you want to save output file
saverds <- "Rcode/allyears/POS/50percent/Output/final_output_allyears_pos_50.rds" # change to where you want to save output file
saverds.af <- "Rcode/allyears/POS/50percent/Output/af_metrics_long_pos_50.rds" # change to where you want to save output file
saverds.mla.ind.model <- "Rcode/allyears/POS/50percent/Output/mla_ind_model_metrics_long_pos_50.rds" # change to where you want to save output file
saverds.mla.ind.pop <- "Rcode/allyears/POS/50percent/Output/mla_ind_pop_metrics_long_pos_50.rds" # change to where you want to save output file
saverds.alk <- "Rcode/allyears/POS/50percent/Output/alk_data_all_pos_50.rds"
saverds.alk.matrix.model <- "Rcode/allyears/POS/50percent/Output/alk.matrix_model_pos_50.rds"
saverds.subset.data <- "Rcode/allyears/POS/50percent/Output/subset_data_50.rds" # change to where you want to save output file
...
{
  tmp<-sim_sample(bin=bin,
                  bin_n=NULL,
                  sample_type="POS",# bin size in mm        
                  supp=TRUE)      
